const projectData = [
  {
    ...
    description: "This fullstack e-commerce site is built primarily utilizing React. It features a headless CMS (Strapi) fully functional user login, integrated Google authentication, shopping cart checkout, order history, and purchase confirmation.",
