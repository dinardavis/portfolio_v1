        ...
        <div className="about-content">      
          ...
          <div className="tech-stack">
            <div className="stack-logos">
              <img src="/public/imgs/techstack/javascript.svg" className="stack-logo" title="Javascript" alt="JavaScript Logo" />
              <img src="/public/imgs/techstack/nodejs.svg" className="stack-logo" title="Node.js" alt="Node.js Logo" />
              <img src="/public/imgs/techstack/react.svg" className="stack-logo" title="React" alt="React Logo" />
              <img src="/public/imgs/techstack/jquery.svg" className="stack-logo" title="jQuery" alt="JQuery Logo" />
              <img src="/public/imgs/techstack/sass.svg" className="stack-logo" title="Sass" alt="Sass Logo" />
              <img src="/public/imgs/techstack/photoshop.svg" className="stack-logo" title="Photoshop" alt="Photoshop Logo" />
              <img src="/public/imgs/techstack/illustrator.svg" className="stack-logo" title="Illustrator" alt="Illustrator Logo" />
            </div>
          </div>
        </div>
      </Section>
