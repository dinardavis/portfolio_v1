    ...
    <section className="intro">
      <div className="greeting-message">
        ...
        <div className='intro-text-container'>
          <p className="paragraph-text intro-text">I'm a Web Developer based in Oakland, CA, focused on connecting with opportunities to build engaging, useful and accessible tools utilizing React.</p>
