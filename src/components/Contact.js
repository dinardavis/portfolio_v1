  ...
  return (
    <section className="contact section-container" id="contact">
      ...
      <div className="contact-info">
        ...
        <a href="mailto:dinardavis@gmail.com?subject=I%20saw%20your%20portfolio%20and..." target="_blank" rel="noopener noreferrer" className="contact-btn-mobile">Talk soon!</a>
      </div>
    </section>
  )
}