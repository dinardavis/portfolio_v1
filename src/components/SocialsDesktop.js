...
export default function SocialsDesktop() {
  return (
      <div className="socials-desktop">
        ...
        <a href={require("../assets/resume.pdf")} download="resume" className="social-link" target="_blank" rel="noopener noreferrer"><img src="imgs/social/cv.svg" title="Download Resumé" alt=""/></a>
      </div>
  )
}